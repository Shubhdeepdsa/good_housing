...
const Story = () => {
    return (
        <>
            <div className="story_container flex bg-[#F6F7F9] items-center justify-center p-28 space-x-28 font-gilroy-regular">
                <div className="story_text_section flex flex-col space-y-6">
                    <p className="text-[#1C4075] text-5xl font-bold">We believe that <br /> everybody has the right <br /> to have a place that <br /> feels like home</p>
