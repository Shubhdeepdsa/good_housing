            ...
            <div className="flex flex-row hero_container justify-center -space-x-20 bg-[#1C4075] items-center tracking-tighter ">
                <div className="hero_text_section  h-[720px] w-[800px]   static ">
                    ...
                    <div className="title_container w-[600px]  absolute z-2 pt-24 pl-28 flex flex-col space-y-6">
                        <p className='text-7xl font-semibold top-0 left-0 text-white font-gilroy-bold  '>Homes that empower extraordinary lives</p>

                        <p className='font-xl leading-8 tracking-wide font-gilroy-medium'>Good Housing provides specialist disability accommodation (SDA) that considers the physical, mental and emotional needs & benefits of the individual.</p>
